...
import { pauseEnvirAni, playEnvirAni, prePathUrl, returnAudioPath, startRepeatAudio, stopRepeatAudio } from '../components/CommonFunctions';
        ...
        >
            ...
            >
                ...
                {[0, 1, 2, 3].map((value, index) =>
                    < BaseImage
                        ...
                        key={index}
                        posInfo={{ l: 0.035, t: 0.065 }}
                        url={"interactive/SB39_Interactive_Icon_12_F" + (index + 1) + ".svg"}
                        geo={_geo}
            ...
            >
                ...
                < BaseImage
                    ...
                    url={"Icons/SB39_Interactive-Icon_SB39_Interactive_Icon_28.svg"}
                    geo={_geo}
                    onLoad={loading}
                />
