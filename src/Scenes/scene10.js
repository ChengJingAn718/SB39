...
import {
    prePathUrl, returnAudioPath,
    playEnvirAni, pauseEnvirAni,
    startRepeatAudio, stopRepeatAudio, setRepeatAudio
            ...
            >
                ...
                {[0, 1, 2, 3].map((value, index) =>
                    < BaseImage
                        ...
                        url={"interactive/SB39_Interactive_Icon_14_F" + (index + 1) + ".svg"}
                        geo={_geo}
