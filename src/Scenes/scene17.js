...
export default function Scene3({ nextFunc, _geo }) {
    ...
    useEffect(() => {
        audioList.bodyAudio1.src = returnAudioPath('28')
        ...
        <div className="aniObject">
            <div className="upDownAni1"
                ...
                <img draggable={false} width={"100%"}
                    src={"./images/Icons/SB39_Interactive-Icon_SB39_ Icon_19.svg"}
                />
            </div>
            ...
            <div ref={refText}
                ...
                style={{
                    ...
                    , left: _geo.left + _geo.width * 0.39 + "px",
                    bottom: "8%",
                }}>
                <img draggable={false} width={"100%"}
                    src={"./images/Text interactive/SB39_Text-Interactive_SB39_Text_Burning_Tar.svg"}
                />
            </div>
        </div>
    );
