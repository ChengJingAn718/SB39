...
export default function Scene3({ nextFunc, _geo }) {
    ...
    useEffect(() => {
        audioList.bodyAudio1.src = returnAudioPath('29')
        ...
        <div className="aniObject">
            <div 
                ...
                <img draggable={false} width={"100%"}
                    src={"./images/Icons/SB39_Interactive-Icon_SB39_ Icon_20.svg"}
                />
            </div>
            ...
            <div ref={refText}
                ...
                <img draggable={false} width={"100%"}
                    src={"./images/Text interactive/SB39_Text-Interactive_SB39_Text_Smoke_From_Factories.svg"}
                />
            </div>
        </div>
    );
