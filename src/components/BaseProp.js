...
const BaseProp = (prop, ref) => {
    ...
    React.useImperativeHandle(ref, () => ({
        ...
        //     basePropRef.current.style.transform = transform
        // },

        setStyle: (styles) => {
            styles.map(style => {
                basePropRef.current.style[style.key] = style.value
            })
        },
    ...
    return (
        <div
            ...
            className={"baseProp commonButton " + (prop.class != null ? prop.class : '')}
            // onMouseEnter={() => {
            //     if (isMouseEnterLeave && prop.posInfo.w1 != null) {
